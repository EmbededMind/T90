...
/*
	¼Ä´æÆ÷SCS
	Î»		·ûºÅ		ÃèÊö
	5 		OSCEN 	Ö÷Õñµ´Æ÷Ê¹ÄÜ ¶Á/Ð´ Ä¬ÈÏÖµ£º0
						0 	Ö÷Õñµ´Æ÷½ûÖ¹
						1		Ö÷Õñµ´Æ÷Ê¹ÄÜ
	6 		OSCSTAT Ö÷Õñµ´Æ÷×´Ì¬ Ö»¶Á Ä¬ÈÏÖµ£º0
						0		Ö÷Õñµ´Æ÷²»ÎÈ¶¨£¬²»ÄÜÓÃ×÷Ê±ÖÓÔ´
						1 	Ö÷Õñµ´Æ÷ÒÑÎÈ¶¨£¬ÄÜ¹»ÓÃ×÷Ê±ÖÓÔ´¡£Ö÷Õñµ´Æ÷±ØÐëÍ¨¹ýOSCENÎ»Ê¹ÄÜ
*/
  LPC_SC->SCS       = SCS_Val;
...
/*
	¼Ä´æÆ÷CLKSRCSEL
	Î»		·ûºÅ		ÃèÊö
	0			CLKSRC	Ñ¡ÔñÏµÍ³Ê±ÖÓºÍPLL0µÄÊ±ÖÓÔ´
						0		Ñ¡ÔñÄÚ²¿RCÕñµ´Æ÷×÷ÎªÏµÍ³Ê±ÖÓºÍPLL0µÄÊ±ÖÓÔ´£¨Ä¬ÈÏ£©
						1		Ñ¡ÔñÖ÷Õñµ´Æ÷×÷ÎªÏµÍ³Ê±ÖÓºÍPLL0µÄÊ±ÖÓÔ´¡£
	31:1	-				±£Áô¡£¶ÁÈ¡ÖµÎ´¶¨Òå£¬Ö»ÄÜÐ´Èë0¡£
*/
  LPC_SC->CLKSRCSEL = CLKSRCSEL_Val;    /* Select Clock Source for sysclk/PLL0*/

#if (PLL0_SETUP)
/* ÕâÀïPLLÊä³öÆµÂÊ = £¨PLL0CFG_Val + 1£© * ¾§ÕñÆµÂÊ */
  LPC_SC->PLL0CFG   = PLL0CFG_Val;
/*
	¼Ä´æÆ÷PLL0CON
	Î»		·ûºÅ		ÃèÊö
	0			PLLE		PLLÊ¹ÄÜ
								µ±¸ÃÎ»Îª1Ê±½«¼¤»îPLL²¢ÔÊÐíÆäËø¶¨µ½Ö¸¶¨µÄÆµÂÊ¡£
	31:1	-				±£Áô¡£¶ÁÈ¡ÖµÎ´¶¨Òå£¬Ö»ÄÜÐ´Èë0¡£
*/
  LPC_SC->PLL0CON   = 0x01;             /* PLL0 Enable                        */
/*
	±ØÐë½«ÕýÈ·µÄÀ¡ËÍÐòÁÐÐ´ÈëPLLFEED¼Ä´æÆ÷£¬²ÅÄÜÈÃÏà¹ØµÄPLLCONÓëPLLCFG¼Ä´æÆ÷ÉúÐ§¡£
	À¡ËÍÐòÁÐÎª£º
	1. ÏòPLLFEEDÖÐÐ´ÈëÖµ0xAA¡£
	2. ÏòPLLFEEDÖÐÐ´ÈëÖµ0x55
*/
...
/*
	¼Ä´æÆ÷PLL0STAT
	Î»		·ûºÅ		ÃèÊö
	10		PLOCK		·´Ó³PLLµÄËø¶¨×´Ì¬
								µ±¸ÃÎ»Îª0Ê±£¬PLLÎ´Ëø¶¨¡£
								µ±¸ÃÎ»Îª1Ê±£¬PLLËø¶¨µ½Ö¸¶¨µÄÆµÂÊ¡£
*/
...
/*
	¼Ä´æÆ÷CCLKSEL
	Î»		·ûºÅ		ÃèÊö
	4:0		CCLKDIV	´ÓÑ¡ÖÐµÄÊ±ÖÓÔ´ÖÐÑ¡ÔñÓÃÓÚCPUÊ±ÖÓ£¨CCLK£©µÄ·ÖÆµÖµ¡£
						1		ÊäÈëÊ±ÖÓ¾­1·ÖÆµºó²úÉúCPUÊ±ÖÓ¡£
	8			CCLKSEL	ÎªCPUÊ±ÖÓ·ÖÆµÆ÷Ñ¡ÔñÊ±ÖÓÔ´¡£
						0		Ñ¡ÔñÏµÍ³Ê±ÖÓ×÷ÎªCPUÊ±ÖÓ·ÖÆµÆ÷µÄÊ±ÖÓÔ´¡£
						1		Ñ¡ÔñÖ÷PLLÊä³ö×÷ÎªCPUÊ±ÖÓ·ÖÆµÆ÷µÄÊ±ÖÓÔ´¡£
*/

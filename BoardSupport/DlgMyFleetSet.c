...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[]  = {
   {HSD_BUTTON_CreateIndirect, "asmmsi", GUI_ID_BUTTON0, 100,100,40,20,0,0,0  }
...
WM_HWIN DLG_MyFleetSetMenuCreate(void)
{
   ...
   handle  = GUI_CreateDialogBox(_aDialogCreate, GUI_COUNTOF(_aDialogCreate), &myDialogCallback, WM_HBKWIN , MAIN_MENU_X+MAIN_MENU_WIDTH, MAIN_MENU_Y);
   return handle;
}
